...
import { Mail, Lock, Eye, EyeOff, Loader2, AlertCircle, User, Gift } from "lucide-react"
      ...
      >
        ...
        <Card className="border-gray-800 bg-gray-900/80 backdrop-blur-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>Join the ultimate IPL prediction platform</CardDescription>
          </CardHeader>
          <CardContent>
            {/* Welcome bonus */}
            <div className="flex items-center gap-3 p-3 rounded-xl bg-yellow-500/10 border border-yellow-500/30 text-yellow-400 mb-6">
              <Gift className="w-5 h-5" />
              <span className="text-sm font-medium">Get 100 PXVIIIPD tokens free on signup!</span>
            </div>
